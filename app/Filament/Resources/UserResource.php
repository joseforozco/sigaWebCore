...
class UserResource extends Resource
{
            ...
            ->recordActions([
                ...
                Action::make('desactivar')
                    ...
                    ->action(function (User $record) {
                        ...
                        try {
                            $record->notify(new \App\Notifications\CuentaSuspendidaNotification());
                        } catch (\Exception) {
                            // No bloquear la acción si el correo falla
                        }
                ...
                Action::make('aprobar')
                    ...
                    ->action(function (User $record, array $data) {
                        ...
                        $record->syncRoles([$data['rol']]);
                        try {
                            $record->notify(new AccesoAprobadoNotification());
                        } catch (\Exception $e) {
                            logger()->warning("No se pudo notificar al usuario {$record->email}: " . $e->getMessage());
                        }
                        Notification::make()
    ...
    {
        return static::getModel()::where('email', '!=', 'joseforozco@gmail.com')->count();
    }
