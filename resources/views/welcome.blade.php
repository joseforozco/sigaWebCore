...
<head>
    ...
    <title>SigaInve - Sistema de Gestión Administrativa</title>

    <link rel="icon" href="{{ asset('images/sigaweb-icon.svg') }}" type="image/svg+xml">
    ...
    <footer class="border-t border-white/5 py-14 px-6 lg:px-12">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p class="text-sm text-slate-400">
                © {{ date('Y') }} <span class="text-slate-500">SIGA Software</span> · Todos los derechos reservados
            </p>
